...
## A partir d'une fonction que chacun prendra le soin d'écrire selon leurs regles d'appellation des jobs, exemple :
...
project_map1 = Project("project-map1",  [job_with_geom1, job_with_geom2, job_with_geom3])
